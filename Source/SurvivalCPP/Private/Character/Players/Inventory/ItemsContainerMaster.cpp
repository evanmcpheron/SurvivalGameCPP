...
#include "SurvivalCPP/Public/Character/Players/Inventory/ItemsContainerMaster.h"
...
{
	AddItem(ItemToAdd);
	UE_LOG(LogTemp, Warning, TEXT("Server_AddItem_Implementation, %d"), Items[0].ItemID);
}
